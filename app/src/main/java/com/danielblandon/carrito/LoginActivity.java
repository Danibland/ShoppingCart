...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEnviarCodigo = findViewById(R.id.BtnEnviarCod);
        ...
        btnEnviarCodigo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(phoneNumber)){
                    Toast.makeText(LoginActivity.this,"Ingresa primero tu número",Toast.LENGTH_SHORT).show();
                }else{
        ...
        btnIniciar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(VerificacionCodigo)){
                    Toast.makeText(LoginActivity.this,"Ingresa El Código",Toast.LENGTH_SHORT).show();
                }else{
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken token) {
                ...
                dialog.dismiss();
                Toast.makeText(LoginActivity.this,"Código Enviado, Revisa tu bandeja de entrada",Toast.LENGTH_SHORT).show();
                numero.setVisibility(View.GONE);
                btnEnviarCodigo.setVisibility(View.GONE);
